...
function build_navBlock() { 
    ...
    <div id="navBlock">
      ...
      <div class="navItem" onclick="navMan('mashup.php')">SALES</div>
...
function lpa_log($log_msg)
{
	...
	//pass data to that file
	$log_file_data = $log_filename.'/lpalog.log';
	$log_msg = "LOG - IP address: " . $_SERVER['REMOTE_ADDR'] . ' - ' . PHP_EOL . date('d/m/Y H:i:s') . ": {$log_msg}" . PHP_EOL . "_______________________" . PHP_EOL;
