...
?>
  ...
  <div id="content">
    <div class="sectionHeader">New User Registration</div>
      ...
      <table borde="0px">
        ...
        <input name="fldusergroup" id="fldusergroupinactive" type="radio" value="standard">
          <label for="StatusinActive">Starndard</label>
        </td>
                  </div>
              </td>
          </tr>
    <tr>
        ...
        <input name="txtStatus" id="txtStockStatusInactive" type="radio" value="D">
