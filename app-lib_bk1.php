...
function build_navBlock() { 
    ...
    <div id="navBlock">
	  ...
	  <div class="navItem" onclick="navMan('profile.php')">PROFILE</div>
	  ...
	  <div class="navItem" onclick="navMan('checkout.php')">CHECK OUT</div>
      ...
      if($isAdmin) {
        ...
        <div class="menuSep"></div>
        <div  class="navItem" onclick=" navMan('CustomerLogin.php')">CUSTOMER PAGE</div>
        <div class="navItem" onclick="navMan('login.php?killses=true')">LOGOUT</div> 
    </div>
<?PHP

/*
		Original code, I removed 'killses=true' from the line
...
function build_ClientnavBlock(){
	...
	<!-- <div id="navBlock">
        ...
        <li class="pointer" ><a onclick="navMan('indexClient.php')">HOME</a></li>
